 ...
 */
public class DeleteImplementationControllerTest extends LambdaTest {
    ...
    @Test
    public void testDeleteImplementationSimple() {
    	String SAMPLE_INPUT_STRING = "{\"filename\": \"QuickSort.java\", \"token\": \"mtdll4k2cgflr3et82fgekdn3q\"}";
